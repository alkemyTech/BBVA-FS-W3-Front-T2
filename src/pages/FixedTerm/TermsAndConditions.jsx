...
export default function TermsAndConditions() {
  return (
    <>
      <Typography variant="body2">INFORMACIÓN RELEVANTE</Typography>
      <Typography variant="caption ">
        ...
        caso de que se haya registrado y que sea necesario para la compra de
        alguno de nuestros productos. no asume la responsabilidad en caso de que
        entregue dicha clave a terceros. Todas las compras y transacciones que
        se lleven a cabo por medio de este sitio web, están sujetas a un proceso
        de confirmación y verificación, el cual podría incluir la verificación
        del stock y disponibilidad de producto, validación de la forma de pago,
        ...
        Online es válido solamente en las compras realizadas en este sitio web.
      </Typography>
      ...
      <Typography variant="body2">USO NO AUTORIZADO</Typography>
      <Typography variant="caption ">
        {" "}
      ...
      <Typography variant="body2"> PROPIEDAD</Typography>
      <Typography variant="caption ">
        {" "}
      ...
      <Typography variant="body2"> POLÍTICA DE REEMBOLSO Y GARANTÍA</Typography>
      <Typography variant="caption ">
        {" "}
        ...
        tiene la responsabilidad de entender antes de comprarlo. Le pedimos que
        lea cuidadosamente antes de comprarlo. Hacemos solamente excepciones con
        ...
        el producto se haya usado correctamente. La garantía no cubre averías o
        daños ocasionados por uso indebido. Los términos de la garantía están
      ...
      <Typography variant="body2"> COMPROBACIÓN ANTIFRAUDE</Typography>
      <Typography variant="caption ">
        {" "}
      ...
      <Typography variant="caption ">
        ...
        momento de crear su cuenta. reserva los derechos de cambiar o de
        modificar estos términos sin previo aviso. Estas terminos y condiciones
